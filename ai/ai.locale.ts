  ...
  en: {
    translation: {
      ...
      form: {
        ...
        apiKey: "API Key",
        crossDeviceKey: "Allow this key on my other devices",
        prompt: "Prompt",
      ...
      tools: {
        createAgent: {
          ...
          params: {
            ...
            model: "默认使用 'nolo/glm-5.2'。复杂任务: 'openai/gpt-5.2'。省成本但复杂: 'openai/gpt-5.1'。追求美观/创意: 'gemini-3-pro-preview'。低成本摘要/推理: 'deepseek-v4-pro'。生成图片: 贵/高质量选 'gemini-3-pro-image-preview'，普通选 'gemini-3.1-flash-image-preview'，最快最便宜选 'gemini-3.1-flash-lite-image'。",
  ...
  ja: {
    translation: {
      ...
      form: {
        ...
        apiKey: "APIキー",
        crossDeviceKey: "他のデバイスでこのキーを使用する",
        prompt: "プロンプト",
