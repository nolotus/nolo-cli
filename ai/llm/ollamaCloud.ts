...
/**
 * Kimi K3 on Ollama Cloud = Moonshot 官方价 × 0.8。
 * 官方: input $3/1M, output $15/1M → 8折 input $2.4, output $12。
 * 与 K2.6 的实测校准价独立维护（K2.6 走 plan usage，K3 走 extra usage credits）。
 */
export const OLLAMA_CLOUD_KIMI_K3_PRICE = {
  input: 2.4,
  output: 12,
} as const;
...
export const ollamaCloudModels = [
  {
    ...
    displayName: "Kimi K3",
    hasVision: true,
    price: { ...OLLAMA_CLOUD_KIMI_K3_PRICE },
