...
/** Low-risk: safe defaults for auto-approve UI primary list */
export const PRIMARY_AUTO_APPROVE_SELF_UPDATE_FIELDS: readonly AgentUpdateField[] = [
  "greeting",
  "introduction",
  "tags",
];

/** Default auto-approve set — same as primary (single source of truth). */
export const DEFAULT_AUTO_APPROVED_SELF_UPDATE_FIELDS: AgentUpdateField[] = [
  ...PRIMARY_AUTO_APPROVE_SELF_UPDATE_FIELDS,
];

/** High-impact fields: optional grouping hint for advanced UI / copy. */
export const HIGH_IMPACT_SELF_UPDATE_FIELDS: readonly AgentUpdateField[] = [
  "prompt",
  "tools",
  "references",
  "model",
