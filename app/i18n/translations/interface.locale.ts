  ...
  [Language.EN]: {
    translation: {
      ...
      quickChat: {
        ...
        placeholderCode: "Describe a code goal, e.g. 'implement login and add tests'",
        placeholderResearch: "Describe market, competitors, or facts to investigate",
        ...
        mode: {
          ...
          code: "Code",
          codeDesc: "Read the project, search first, then plan and execute",
          research: "Research",
          researchDesc: "Market, competitors, product, and external fact-finding",
          custom: "Custom",
  ...
  [Language.ZH_CN]: {
    translation: {
      ...
      quickChat: {
        ...
        placeholderCode: "描述代码目标，例如「实现登录接口并补测试」",
        placeholderResearch: "描述要调查的市场、竞品或事实，例如「对比三家竞品定价」",
        ...
        mode: {
          ...
          code: "代码",
          codeDesc: "读取项目、先搜索再规划执行",
          research: "调研",
          researchDesc: "市场、竞品、产品与外部事实调查",
          custom: "定制",
...
quickChat: {
        ...
        placeholderCode: "描述程式目標，例如「實作登入介面並補測試」",
        placeholderResearch: "描述要調查的市場、競品或事實，例如「對比三家競品定價」",
        placeholderBalanced: "用 {{name}} 深度推理",
        placeholderQuality: "用 {{name}} 深入分析",
        ...
        mode: {
          ...
          code: "程式",
          codeDesc: "讀取專案、先搜尋再規劃執行",
          research: "調研",
          researchDesc: "市場、競品、產品與外部事實調查",
          custom: "自訂",
  ...
  [Language.JA]: {
    translation: {
      ...
      quickChat: {
        ...
        placeholderCode: "コードの目標を書いてください（例：ログイン実装とテスト追加）",
        placeholderResearch: "調査したい市場・競合・事実を書いてください",
        ...
        mode: {
          ...
          code: "コード",
          codeDesc: "プロジェクトを読み、検索してから計画・実行",
          research: "リサーチ",
          researchDesc: "市場・競合・製品と外部事実の調査",
          custom: "カスタム",
