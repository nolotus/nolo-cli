  ...
  [Language.EN]: {
    translation: {
      ...
      autoSaveIntervalMinutes: "{{count}}m",
        ...
        memory: {
          title: "Memory",
          description: "Manage your long-term memories that Nolo uses to personalize responses.",
        ...
        commandEmpty: "To connect another computer, generate an API key first, then copy the command.",
        empty: {
        ...
        testCli: "Test",
        noCliHint: "This computer is linked, but we have not detected Codex, Copilot, Claude, Qoder, or Gemini yet. Install the CLI and restart the connection script to be recognized automatically.",
      },
        secrets: {
        title: "Secrets",
        ...
        invalidKey: "Keys may only contain uppercase letters, digits, and underscores, up to 64 chars.",
        ...
        externalReader: {
        title: "External Platform Readers (External Readers)",
        ...
        description: "View the runtime policies of external platform Reader APIs. Xiaohongshu currently only supports anonymous public reading: no login, no cookie saving, no persistent browser profile; content that cannot be seen will be reported as anonymous-only.",
        ...
        guide: {
          needsLogin: "Tip: This page requires login to access. The Xiaohongshu reader is currently in anonymous mode and will not request login or use an account.",
          blocked: "Tip: Access is restricted or a security verification was triggered. Anonymous mode will stop reading and will not request login or bypass verification.",
          error: "Tip: The reader encountered an unexpected error. Anonymous mode has no local login state to reset. Please retry later or check the Playwright environment.",
        },
      },
      },
      userProfile: {
      ...
      quickChat: {
        ...
        placeholderBalanced: "Use {{name}} for deep reasoning",
        placeholderQuality: "Use {{name}} for in-depth analysis",
        emptyPlaceholder: "Tell me your goal, e.g. 'help me organize my thoughts'",
        defaultAgentName: "nolo",
        chipBrainstorm: "Brainstorm",
        chipWrite: "Help me write",
        chipAnalyze: "Analyze data",
        chipTranslate: "Translate",
        chipBrainstormPrompt: "Help me brainstorm",
        chipWritePrompt: "Help me write an article",
        chipAnalyzePrompt: "Help me analyze this data",
        chipTranslatePrompt: "Help me translate this content",
        mode: {
          triggerLabel: "Choose quick chat mode",
          popoverLabel: "Choose quick chat mode",
          hint: "Choose quick chat mode",
          auto: "Auto",
          autoDesc: "Picks the best model based on your message",
          custom: "Custom",
          customDesc: "Assign an agent per scenario",
          customTitle: "Custom agents",
          customHint: "Choose the agent to use for each scenario",
          back: "Back",
          tierFlash: "Fast",
          tierBalanced: "Balanced",
          tierQuality: "Quality",
          tierImage: "Image",
          selectAgentHint: "Favorited agents",
          systemDefault: "System default",
  ...
  [Language.ZH_CN]: {
    translation: {
      ...
      autoSaveIntervalMinutes: "{{count}}m",
        ...
        memory: {
          title: "记忆管理",
          description: "管理 Nolo 用于个性化回应的长期记忆。",
          delete: "删除记忆",
        ...
        externalReader: {
        title: "外部平台读取器 (External Readers)",
        desktopRequiredBadge: "需要桌面端",
        desktopRequired: "请在桌面端管理外部平台读取器",
        desktopRequiredTooltip: "请在桌面端管理外部平台读取器",
        description: "查看外部平台 Reader 接口的运行时策略。小红书目前仅支持匿名公开读取：不登录、不保存 Cookie、不保留持久化浏览器配置；无法看到的内容将被报告为仅匿名可见。",
        checkPolicy: "查看策略",
        ...
        guide: {
          needsLogin: "提示：该页面需要登录后才能访问。小红书读取器当前处于匿名模式，不会请求登录，也不会使用任何账号。",
          blocked: "提示：访问受限或触发了安全验证。匿名模式会停止读取，不会请求登录，也不会绕过验证。",
          error: "提示：读取器发生了意外错误。匿名模式下没有可重置的本地登录状态。请稍后重试，或检查 Playwright 环境。",
        },
      },
      },
      userProfile: {
      ...
      quickChat: {
        ...
        placeholderBalanced: "用 {{name}} 深度推理",
        placeholderQuality: "用 {{name}} 深入分析",
        ...
        chipWritePrompt: "帮我写一篇文章",
        chipAnalyzePrompt: "帮我分析这些数据",
        chipTranslatePrompt: "帮我翻译以下内容",
        mode: {
          triggerLabel: "选择对话模式",
          popoverLabel: "选择对话模式",
          hint: "选择对话模式",
          auto: "自动",
          autoDesc: "根据消息自动切换最优模型",
          custom: "定制",
          customDesc: "为每种场景指定智能体",
          customTitle: "定制智能体",
          customHint: "为每种场景选择要使用的智能体",
          back: "返回",
          tierFlash: "快速",
          tierBalanced: "平衡",
          tierQuality: "质量",
          tierImage: "图片",
          selectAgentHint: "收藏的智能体",
          systemDefault: "系统默认",
  ...
  [Language.ZH_HANT]: {
    translation: {
      ...
      autoSaveIntervalMinutes: "{{count}}m",
        ...
        memory: {
          title: "記憶管理",
          description: "管理 Nolo 用於個人化回應的長期記憶。",
          delete: "刪除記憶",
        ...
        externalReader: {
        title: "外部平台讀取器 (External Readers)",
        desktopRequiredBadge: "需要桌面端",
        desktopRequired: "請在桌面端管理外部平台讀取器",
        desktopRequiredTooltip: "請在桌面端管理外部平台讀取器",
        description: "查看外部平台 Reader 介面的執行時策略。小紅書目前僅支援匿名公開讀取：不登入、不儲存 Cookie、不保留持久化瀏覽器設定；無法看到的內容將被回報為僅匿名可見。",
        checkPolicy: "查看策略",
        ...
        guide: {
          needsLogin: "提示：此頁面需要登入後才能存取。小紅書讀取器目前處於匿名模式，不會請求登入，也不會使用任何帳號。",
          blocked: "提示：存取受限或觸發了安全驗證。匿名模式會停止讀取，不會請求登入，也不會繞過驗證。",
          error: "提示：讀取器發生了意外錯誤。匿名模式下沒有可重設的本機登入狀態。請稍後重試，或檢查 Playwright 環境。",
        },
      },
      },
      userProfile: {
...
quickChat: {
        ...
        chipWritePrompt: "幫我寫一篇文章",
        chipAnalyzePrompt: "幫我分析這些資料",
        chipTranslatePrompt: "幫我翻譯以下內容",
        mode: {
          triggerLabel: "選擇對話模式",
          popoverLabel: "選擇對話模式",
          hint: "選擇對話模式",
          auto: "自動",
          autoDesc: "依訊息自動切換最合適的模型",
          custom: "自訂",
          customDesc: "為每種情境指定智慧體",
          customTitle: "自訂智慧體",
          customHint: "為每種情境選擇要使用的智慧體",
          back: "返回",
          tierFlash: "快速",
          tierBalanced: "平衡",
          tierQuality: "品質",
          tierImage: "圖片",
          selectAgentHint: "收藏的智慧體",
          systemDefault: "系統預設",
  ...
  [Language.JA]: {
    translation: {
      ...
      autoSaveIntervalMinutes: "{{count}}m",
        ...
        memory: {
          title: "記憶管理",
          description: "Nolo が応答をパーソナライズするために使用する長期記憶を管理します。",
          delete: "記憶を削除",
        ...
        externalReader: {
        title: "外部プラットフォームリーダー (External Readers)",
        ...
        description: "外部プラットフォームの Reader API の実行時ポリシーを確認します。XIAOHONGSHU(小紅書)は現在、匿名の公開読取のみをサポートしています：ログインせず、Cookie を保存せず、永続的なブラウザープロファイルも保持しません。閲覧できないコンテンツは匿名のみとして報告されます。",
        checkPolicy: "ポリシーを確認",
        ...
        guide: {
          needsLogin: "ヒント：このページはアクセスにログインが必要です。小紅書のリーダーは現在匿名モードのため、ログインを要求したりアカウントを使用したりすることはありません。",
          blocked: "ヒント：アクセスが制限されているか、セキュリティ検証が作動しました。匿名モードは読取を停止し、ログインを要求したり検証を回避したりすることはありません。",
          error: "ヒント：リーダーで予期しないエラーが発生しました。匿名モードにはリセットできるローカルログイン状態がありません。しばらくしてから再試行するか、Playwright 環境を確認してください。",
        },
      },
      },
      userProfile: {
      ...
      quickChat: {
        ...
        placeholderBalanced: "{{name}} で深く推論",
        placeholderQuality: "{{name}} で深く分析",
        ...
        chipWritePrompt: "記事を書くのを手伝って",
        chipAnalyzePrompt: "このデータを分析して",
        chipTranslatePrompt: "次の内容を翻訳して",
        mode: {
          triggerLabel: "クイックチャットのモードを選択",
          popoverLabel: "クイックチャットのモードを選択",
          hint: "クイックチャットのモードを選択",
          auto: "自動",
          autoDesc: "メッセージに応じて最適なモデルを選ぶ",
          custom: "カスタム",
          customDesc: "シーンごとにエージェントを指定",
          customTitle: "カスタムエージェント",
          customHint: "シーンごとに使うエージェントを選択",
          back: "戻る",
          tierFlash: "高速",
          tierBalanced: "バランス",
          tierQuality: "高品質",
