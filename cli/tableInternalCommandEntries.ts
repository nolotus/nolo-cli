...
export function renderTableHelpText() {
  return [
    ...
    "",
    "Usage:",
    "  nolo table list [--limit <n>] [--all] [--output items|json|jsonl]",
    "  nolo table query --table <tableId|metaKey> [--row <rowId|rowDbKey>] [--limit <n>] [--offset <n>] [--all] [--output items|json|jsonl]",
    "    Defaults: list --limit 50, query --limit 20. Full dump: --all or --limit 0 (prefer --output jsonl).",
