...
export const PUBLIC_QWEN_37_FLASH_AGENT_ID = entry("01QWEN37FLASH000000000001").id;
export const PUBLIC_QWEN_37_FLASH_AGENT_KEY = publicAgentKey(PUBLIC_QWEN_37_FLASH_AGENT_ID);
